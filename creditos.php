...
-->
    ...
    <div class="container" style=" background-color: rgb(176, 191, 255);text-align: center;margin-left:30% ;margin-right:30%;margin-bottom:30%">
        <div class="container">
            <div class="row">
              <div class="col">
                <h3 style="background-color:white;margin: 5%;margin-left: 30%;margin-right: 30%">
                  <a href="https://www.faeterj-rio.edu.br" target="_blank" rel="noopener noreferrer">FAETERJ-Rio</a></h3>
                  <!-- link externo para a faculdade em nova aba-->
                  </div>
          </div>
          <!--
          <div class="col">
            <h3 style="background-color:white;;margin-left: 30%;margin-right: 30%;margin-bottom: 5%">FAETERJ Petrópolis</h3>
          </div>
          <div class="col">
            <h3 style="background-color:white;;margin-left: 30%;margin-right: 30%">FAETERJ Bom Jesus</h3><br><br>
          </div>
        -->
        </div>
    </div>
