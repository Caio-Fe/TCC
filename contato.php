...
<head>
    ...
    <title>Repositório: Contato</title>
     <!-- add icon link -->
     <link rel="icon" href=
"img/image2.jpg"
          type="image/x-icon">
...
-->
    ...
    <div class="container" style=" background-color: rgb(176, 191, 255);text-align: center;margin-left:30% ;margin-right:30%;margin-bottom:30%">
        <div class="container">
            <div class="row">
              <div class="col" style="margin: 5%;margin-left: 30%;margin-right: 30%;border:solid 1px">
                <h3 style="background-color:white;">FAETERJ-Rio</h3>
                <!-- <h5 >Contato</h5><br> teste-->
                    <p style="border-bottom:solid 1px">
                    Telefone: (21) 2332-4048<br>
                    Email: sec_acad@faeterj-rio.edu.br<br>
                    Rua Clarimundo de Melo, 847 Quintino, Rio de Janeiro, RJ<br>
                </p>
                </div>
                <!--
                <div class="col">
                    <h3 style="background-color:white;">FAETERJ Petrópolis</h3>
                   <p style="border-bottom:solid 1px">
                    Telefone: (24) 2235-1079<br>
                    Email: contato@faeterj-petropolis.edu.br<br>
                    Avenida Getúlio Vargas, 335 - Quitandinha - Petrópolis - RJ<br>
                </p>
                   </div>
                   <div class="col">
                     <h3 style="background-color:white;">FAETERJ Bom Jesus</h3>
                     Telefone: (22) 3831-6716<br>
                     Email: -<br>
                     Rua Aristides Figueiredo, 147, Centro Bom Jesus do Itabapoana – RJ.<br>
                 </div> -->
              </div>
          </div>
