...
<head>
    ...
    <!--Bootstrap CSS-->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css"rel="stylesheet"integrity="sha384-EVSTQN3azprG1Anm3QDgpJLIm9Nao0Yz1z
    tcQTwFspd3yD65VohhpuuCOmLASjC"
...
<body>
    ...
    text-align: center; margin-left:30% ;margin-right:30%;margin-bottom:30%">
        <h3>
        Biblioteca de Trabalhos de Conclusão de
        <br>
