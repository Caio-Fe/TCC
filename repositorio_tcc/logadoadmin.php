...
<head>
    ...
    <title>Repositório: Logado Admin</title>
    <!-- add icon link -->
...
<body onload="if (document.referrer == '') self.location='index.php';">
    ...
    <div class="container" style=" background-color: rgb(176, 191, 255);
    text-align: center;margin-left:30% ;margin-right:30%;margin-bottom:30%">
        <h3>Biblioteca de Trabalhos de Conclusão de<br> Curso da Faculdade
        de Educação Tecnológica do Estado do Rio de Janeiro</h3>
        <!--Grid do counteudo 1-->
        <div class="row" style="padding:10px">
            ...
            <div>
                ...
                Com o surgimento de sistemas embarcados com propositos educacionais 
                a criacao de projetos embarcados tornou-se economicamente viavel, 
                aumentando o numero de usuarios que se aventuram nessa área. Neste...<br>
