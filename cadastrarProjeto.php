...
<body onload="if (document.referrer == '') self.location='index.php';">
    ...
    <?php include_once 'lateralBibliotecario.php'; ?>

    <!--Conteudo do corpo-->
    <!--Grid do corpo-->
    <div class="col-lg-6" style="padding-top:100px">
    <div class="container" style=" background-color:#435281;;text-align: center;
    margin-left:50% ;margin-right:50%;margin-bottom:30%; color:#fff;">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (isset($_FILES['pdf_file']['name'])) {
                    ...
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <strong>Cadastro realizado com!</strong>
                    </div>
                    <?php
                    }
        ...
        <div class="form-input py-2">
            ...
            <form method="post" enctype="multipart/form-data" id="projform">
                ...
                <label>Arquivo em formato PDF</label>
                    ...
                    <div class="form-group">
                        <input type="submit"
                            class="btnRegister" name="submit" id="submit" value="Cadastrar Projeto">
                    </div>
                </div>
        </form>
        </div>
