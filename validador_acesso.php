...
if ($_SESSION['perfil_id'] == '1' && $_SERVER['REQUEST_URI'] == '/TCC/alterarProjeto.php') {
    header(REDIRECT_URL);
}
if ($_SESSION['perfil_id'] == '1' && $_SERVER['REQUEST_URI'] == '/TCC/deletarProjeto.php') {
    header(REDIRECT_URL);
}
...
if ($_SESSION['perfil_id'] == '2' && $_SERVER['REQUEST_URI'] == '/TCC/alterarUsuario.php') {
    header(REDIRECT_URL);
}
