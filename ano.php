    ...
    <div style="background-color: #4304f0; display:inline-block; margin-top: 5px;border-radius: 5px;">
        <div class="d-flex flex-column flex-shrink-0 p-3 " style=" width: 280px; margin-top:50px;height: 90%;">
            <ul class="nav nav-pills flex-column mb-auto">
              <li class="nav-item">
                <a href="ano.php" class="nav-link active" aria-current="page">
          ...
          <div class="container">
            <div class="row">
              <div class="col" style="border:solid 2px"> 
                <!-- dados não vindo de banco, apenas estão printados na tela para exemplo-->
              <h4 style="background-color:rgb(255, 193, 24)">Ano</h4>
              <p style="background-color:rgb(176, 198, 255)">2022</p>
              <p style="background-color:rgb(161, 174, 243)">2021</p>
              <p style="background-color:rgb(176, 198, 255)">2020</p>
              <p style="background-color:rgb(161, 174, 243)">2019</p>
              <p style="background-color:rgb(176, 198, 255)">2018</p>
              <p style="background-color:rgb(161, 174, 243)">2017</p>
              <p style="background-color:rgb(176, 198, 255)">2016</p>
              <p style="background-color:rgb(161, 174, 243)">2015</p>
              <p style="background-color:rgb(176, 198, 255)">2014</p>
              <p style="background-color:rgb(161, 174, 243)">2013</p>
              </div>
              <div class="col" style="border:solid 2px">
